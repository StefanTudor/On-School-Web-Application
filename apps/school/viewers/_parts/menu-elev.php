    ...
    <div class="bg-dark p-3">
        ...
        <ul class="navbar-nav text-center">
            <li class="nav-item active">
                <a class="nav-link text-light" href="/elev">Acasă</a>
            </li>
            <li class="nav-item active">
                <a class="nav-link text-light" href="/elev/orar">Orar</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-light" href="/elev/note">Note</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-light" href="/elev/calendar">Calendar</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-light" href="/elev/lista-profesori">Profesori</a>
            </li>
        </ul>
    </div>
</div>