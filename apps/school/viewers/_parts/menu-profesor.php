...
<div class="dropdown" style="z-index: 12;">
    <a class="btn mt-2 p-0 d-flex align-items-center" id="btn-user" href="#" role="button" id="dropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <span class="badge badge-light text-dark p-2 pr-4" style="font-size: 1rem; top: 0.6rem; right: 2.5rem;">Prof. <?php echo $_SESSION["userName"] ?></span>
...
<nav class="navbar navbar-dark position-fixed w-100 bg-dark">
    ...
    <a href="/">
        <h1 class="text-light text-center w-100 p-1 text-uppercase" id="school-h1">
            <a href="/profesor" id="link-scoala"><?php echo $_SESSION["scoala"] ?></a>
        </h1>
    ...
    <div class="bg-dark p-3">
        ...
        <ul class="navbar-nav text-center">
            <li class="nav-item active">
                <a class="nav-link text-light" href="/profesor">Acasă</a>
            </li>
            <li class="nav-item active">
                <a class="nav-link text-light" href="<?php echo BASE_URL; ?>/profesor/orar?profesor=<?php echo $_SESSION['userId']?>">Orar</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-light" href="/profesor/note">Note elevi</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-light" href="/profesor/calendar">Calendar</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-light" href="/profesor/lista-profesori">Profesori</a>
            </li>
        </ul>
    </div>
</div>